...
\def\MiniBatchColor{rgb:blue,2;green,1;black,0.3}
\def\RawBox{rgb:white,30;black,10}
"""
...
def to_input( pathfile, to='-6,0,0', width=8, height=8, name="temp" ):
    return r"""
...
def to_skip_south( of, to, pos=1.25):
    return r"""
\path ("""+ of +"""-northeast) -- ("""+ of +"""-southeast) coordinate[pos="""+ str(pos) +"""] ("""+ of +"""-top) ;
\path ("""+ to +"""-north)  -- ("""+ to +"""-south)  coordinate[pos="""+ str(pos) +"""] ("""+ to +"""-top) ;
